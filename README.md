...
services:
  mqtt-weatherstation-bridge:
    image: ghcr.io/terafin/mqtt-weatherstation-bridge:latest
    environment:
      ...
      (OPTIONAL) WUNDERGROUND_STATION_ID: YOUR_WUNDERGROUND_STATION_ID
      (OPTIONAL) WUNDERGROUND_STATION_KEY: YOUR_WUNDERGROUND_STATION_KEY
